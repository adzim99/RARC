...
urlpatterns = [
    ...
    path('approve_booking/<str:pk>/', views.editBooking, name="approve_booking"),
    path('reject_booking/<str:pk>/', views.deleteBooking, name="reject_booking"),
    ...
    path('applicant_feedback/', views.applicantFeedback, name="applicant_feedback"),
]